...
(a) HLS Front End: This is performed using our HLS HLT Tool. The Tool requires java development kit (jdk) installed for executing the HLS HLT tool. This Tool converts a raw DFG into a processed (transformed) DFG intermediate representation (IR) using a set of structural transformation algorithms such as THT, LU, LICM, ROE etc. (adopted from the references below). The jdk can be downloaded and installed from the following: https://javadl.oracle.com/webapps/download/AutoDL?BundleId=253194_f7fe8e644f724108bdb54139381e29a7    
