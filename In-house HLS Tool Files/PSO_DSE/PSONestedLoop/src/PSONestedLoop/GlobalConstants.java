...
public class GlobalConstants {
    ...
    public Vector<Object> operation;
     public  Vector <Object> loopbody;
    public Vector <Object> unrollbody;
    public Vector <Object> conditionstr;
    public Vector<Object> beforeloop;
    public Vector<Object> afterloop;
    public Vector<Vector> LUFL;
   ...
   // public Vector<Object> resource;
    ...
    public boolean nestedloop=false;
    int predictcount=0;
    public int totalITR=0;
    //public double power[][];
   // public double exetime[][];
    ...
    public int noofresources=0,noofnestedloop=0;
    //new variable for nested loop problem
    
    public Vector<Integer> loopcount;
